//! Together AI provider — open-source model hosting via Together API.
...
impl TogetherProvider {
    ...
    pub fn from_env() -> Option<Self> {
        std::env::var("TOGETHER_API_KEY").ok().map(Self::new)
    }
    ...
    fn static_models() -> Vec<ModelInfo> {
        vec![
            ModelInfo {
                ...
                display_name: "Llama 3.3 70B Turbo".into(),
            ...
            ModelInfo {
                ...
                display_name: "DeepSeek R1 (via Together)".into(),
            ...
            ModelInfo {
                ...
                display_name: "Qwen 2.5 72B Turbo".into(),
                context_length: 32768,
...
impl LlmProvider for TogetherProvider {
    ...
    async fn complete(&self, req: &CompletionRequest) -> Result<CompletionResponse, ProviderError> {
        ...
        debug!(provider = "together", model, "sending completion request");
    ...
    {
        Err(ProviderError::Stream("streaming not yet implemented for together".into()))
    }
