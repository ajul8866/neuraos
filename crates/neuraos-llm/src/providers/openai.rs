//! OpenAiProvider provider — OpenAI-compatible API.
...
impl OpenAiProvider {
    ...
    fn static_models() -> Vec<ModelInfo> {
        vec![
            ModelInfo {
                id: "gpt-4o".into(), display_name: "GPT-4o".into(),
                context_length: 128000, cost_per_1k_input: 0.005, cost_per_1k_output: 0.015,
                supports_vision: true, supports_function_calling: true,
                supports_json_mode: true,
            },
            ModelInfo {
                id: "gpt-4o-mini".into(), display_name: "GPT-4o Mini".into(),
                context_length: 128000, cost_per_1k_input: 0.00015, cost_per_1k_output: 0.0006,
                supports_vision: false, supports_function_calling: true,
                supports_json_mode: true,
            },
            ModelInfo {
                id: "gpt-4-turbo".into(), display_name: "GPT-4 Turbo".into(),
                context_length: 128000, cost_per_1k_input: 0.01, cost_per_1k_output: 0.03,
                supports_vision: true, supports_function_calling: true,
                supports_json_mode: true,
            },
            ModelInfo {
                id: "gpt-3.5-turbo".into(), display_name: "GPT-3.5 Turbo".into(),
                context_length: 16385, cost_per_1k_input: 0.0005, cost_per_1k_output: 0.0015,
                supports_vision: false, supports_function_calling: true,
                supports_json_mode: true,
            },
            ModelInfo {
                id: "o1-mini".into(), display_name: "o1-mini".into(),
                context_length: 128000, cost_per_1k_input: 0.003, cost_per_1k_output: 0.012,
...
impl LlmProvider for OpenAiProvider {
    ...
    {
        Err(ProviderError::Stream("streaming not yet implemented for openai".into()))
    }
